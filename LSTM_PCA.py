    ...
    for value in hyperparameter_value:
        ...
        for model in data_models:
            ...
            if value == 'MLP':
                ...
                Utils.pca_classificationMetrics("LSTM", mlp_datamodel, x_test, y_test, model, value)
                ...
                Utils.pca_classificationMetrics("LSTM", seq_datamodel, x_test, y_test, model, value)
